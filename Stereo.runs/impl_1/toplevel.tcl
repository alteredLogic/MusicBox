...
set rc [catch {
  ...
  add_files -quiet C:/Users/Matthew/Stereo/Stereo.runs/synth_1/toplevel.dcp
  ...
  link_design -top toplevel -part xc7a35ticpg236-1L
...
set rc [catch {
  ...
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -file toplevel_control_sets_placed.rpt"
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -file toplevel_timing_summary_routed.rpt -warn_on_violation  -rpx toplevel_timing_summary_routed.rpx"
